document.addEventListener('DOMContentLoaded', function () {
  ...
  confirmBtn.addEventListener('click', () => {
    ...
    if (currentAccount !== selectedAccountId) {
      ...
      customerProfileName.innerHTML = `<div class="customer__wrapper"><span class="customer__badge">Klant</span><span class="customer__specs">${accountDisplayName.address1 ? `${accountDisplayName.address1} |` : ``} ${accountDisplayName.company ? `${accountDisplayName.company} |` : ``} ${accountDisplayName.email} </span></div>`;
      revertBtn.style.display = 'inline-block';
      accountModal.close();
